    ...
    <div class="pagin">
        ...
        <ul class="paginList">
            ...
            <c:if test="${products.pageCount eq 1}">
                ...
                <li class="paginItem"><a href="<%=basePath%>admin/product/productmanage/productManage?pageCount=1">首页</a></li>
                <li class="paginItem"><a href="<%=basePath%>admin/product/productmanage/productManage?pageCount=1">上一页</a></li>
            ...
            <c:if test="${products.pageCount > 1}">
                ...
                <li class="paginItem"><a href="<%=basePath%>admin/product/productmanage/productManage?pageCount=${page.pageCount-1}">上一页</a></li>

            </c:if>
            <c:if test="${products.totalPageCount<5}">
                <c:forEach begin="1" end="${products.totalPageCount}" varStatus="index">

                    <li class="paginItem"><a id="${index.index }" href="<%=basePath%>admin/product/productmanage/productManage?pageCount=${index.index}"><font>${index.index}</font></a></li>
            ...
            <c:if test="${page.pageCount eq page.totalPageCount}">
                ...
                <li class="paginItem"> <a href="<%=basePath%>admin/product/productmanage/productManage?pageCount=${products.totalPageCount}">下一页</a></li>
                <li class="paginItem"> <a href="<%=basePath%>admin/product/productmanage/productManage?pageCount=${products.totalPageCount}">尾页</a></li>
            </c:if>

            <c:if test="${products.pageCount < products.totalPageCount}">
                <li class="paginItem"><a href="<%=basePath%>admin/product/productmanage/productManage?pageCount=${products.pageCount+1}">下一页</a></li>
