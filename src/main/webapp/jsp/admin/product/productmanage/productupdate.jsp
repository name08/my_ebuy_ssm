...
<body>
    ...
    <div class="formtitle"><span>产品信息编辑</span></div>
        ...
        <ul class="forminfo">
            <li>
                ...
                <select id="productTypeId" name="productTypeId" class="dfinput">
                    ...
                    >${productType.pt_name}</option>

                    </c:forEach>
                </select>
                <i id="productTypeIdError"></i>
            </li>
            <li><label>*产品名称</label><input id="p_name" name="p_name" type="text" class="dfinput" value="${product.p_name}"><i id="p_nameError"></i></li>
            <li><label>*产品图片</label>
                <input id="url1" name="p_picUrl" type="text" class="dfinput" value="${product.p_picUrl}" readonly="readonly">
            ...
            <li><label>*产品原价</label><input id="p_originalPrice" name="p_originalPrice" type="text" class="dfinput" value="${product.p_originalPrice}"><i id="p_originalPriceError"></li>
            <li><label>*产品现价</label><input id="p_price" name="p_price" type="text" class="dfinput" value="${product.p_price}"><i id="p_priceError"></i></li>
                ...
                <select id="p_onSale" name="p_onSale" class="dfinput">
                    <c:choose>
                        <c:when test="${product.p_onSale == 1}">
                            <option value="${product.p_onSale}" selected="selected">上架</option>
                            <option value="${product.p_onSale-1}">已下架</option>
                        </c:when>
                        <c:otherwise>
                            <option value="${product.p_onSale+1}">上架</option>
                            <option value="${product.p_onSale}" selected="selected">已下架</option>
                        </c:otherwise>
                    </c:choose>
                </select>
            ...
            <li><label>*产品描述</label>
                <textarea id="p_description" name="p_description" cols="" rows="" class="textinput">${product.p_description}</textarea><i id="p_descriptionError"></i>
            </li>
            <li><label>*产品内容</label>
                <textarea id="p_content" name="p_content" class="textinput" style="display: none;">${product.p_content}</textarea>
                <i id="p_contentError"></i>
            </li>
            <li><label>&nbsp;</label><input id="UpdateProduct_button" name="" type="button" class="btn" value="编辑产品信息">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="returnProductManage" type="button" class="btn" value="返回产品管理"/></li>
        </ul>
    </form>
