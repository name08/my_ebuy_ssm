...
<link href="<%=basePath%>jsp/admin/css/style.css" rel="stylesheet" type="text/css" />
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#UpdateCustomer_Button").click(function(e) {
                ...
                }else if(!isNumber(c_telephoneVal)){
                    status = false;
                    $('#c_telephoneError').html("手机号有非法字符");
                }else {
                ...
                if(status == true){
                    $.post("<%=basePath %>admin/CustomerManage/doUpdateCustomer",
                        $("#UpdateCustomer").serialize(),
                        function(data) {
                            //jquery自带的json转换方法
