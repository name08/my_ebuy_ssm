...
<head>
    ...
    <script src="<%=basePath%>jsp/admin/js/cloud.js" type="text/javascript"></script>
    ...
    <div class="loginbox">
        <form id="LoginForm" method="post">
            <ul>
                ...
                <li><input id="Login_Button" name="" type="button" class="loginbtn" value="登录"/><label><input name="" type="checkbox" value="" checked="checked" />记住密码</label><label><a href="#">忘记密码？</a></label></li>
            </ul>
        </form>
