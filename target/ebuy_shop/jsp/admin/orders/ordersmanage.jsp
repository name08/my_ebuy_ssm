...
<body>
    ...
    <div class="tools">
        <form action="<%=basePath%>admin/orders/ordersManage/LikeOrders" method="get">
    ...
    <c:otherwise>
        <center><br><font  style="color: red;">很遗憾，当前还没有订单,等一会再看看吧。</font></center>
    </c:otherwise>
    </c:choose>
    <div class="pagin">
        ...
        <ul class="paginList">
            ...
            <c:if test="${orders.pageCount eq 1}">
                ...
                <li class="paginItem"><a href="<%=basePath%>admin/orders/ordersManage/queryOrdersPage?pageCount=1">首页</a></li>
                <li class="paginItem"><a href="<%=basePath%>admin/orders/ordersManage/queryOrdersPage?pageCount=1">上一页</a></li>
            ...
            <c:if test="${orders.pageCount > 1}">
                ...
                <li class="paginItem"><a href="<%=basePath%>admin/orders/ordersManage/queryOrdersPage?pageCount=${page.pageCount-1}">上一页</a></li>

            </c:if>
            <c:if test="${orders.totalPageCount<5}">
                <c:forEach begin="1" end="${orders.totalPageCount}" varStatus="index">

                    <li class="paginItem"><a id="${index.index }" href="<%=basePath%>admin/orders/ordersManage/queryOrdersPage?pageCount=${index.index}"><font>${index.index}</font></a></li>
            ...
            <c:if test="${page.pageCount eq page.totalPageCount}">
                ...
                <li class="paginItem"> <a href="<%=basePath%>admin/orders/ordersManage/queryOrdersPage?pageCount=${orders.totalPageCount}">下一页</a></li>
                <li class="paginItem"> <a href="<%=basePath%>admin/orders/ordersManage/queryOrdersPage?pageCount=${orders.totalPageCount}">尾页</a></li>
            </c:if>

            <c:if test="${orders.pageCount < orders.totalPageCount}">
                <li class="paginItem"><a href="<%=basePath%>admin/orders/ordersManage/queryOrdersPage?pageCount=${orders.pageCount+1}">下一页</a></li>
